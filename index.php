                        ...
                        <div class="bg-form mb-3 d-flex justify-content-center align-items-center " style="flex-direction:columm;background-color: #ECEFF1  ;border-radius:100px 0px 100px 0px">
                            ...
                            <div class="col-md-6 col-sm-4">
                                <form method="POST" action="">
                                    ...
                                    <input type="name"  name="username"class="form-control   mt-4" id="inputname" placeholder="Enter Name here" style="background-color: #ffffff;color:#3949AB ;border-radius: 5px;text-transform:capitalize;" required autocomplete="off">
                                    <input type="email" name="email" class="form-control   mt-4" id="inputemail" placeholder="Enter Email here" style="background-color: #ffffff;color:#3949AB ;border-radius: 5px;text-transform:lowercase;" required autocomplete="off">
                                    <input type="name"  name="address"class="form-control   mt-4" id="inputadress" placeholder="Enter Address here" style="background-color: #ffffff;color:#3949AB ;border-radius: 5px;text-transform:capitalize;" required autocomplete="off">
                                    <input type="name"  name="jobpost"class="form-control  mt-4" id="inputjobpost" placeholder="Enter Job Post here" style="background-color: #ffffff;color:#3949AB ;border-radius: 5px;text-transform:capitalize;" required autocomplete="off">
